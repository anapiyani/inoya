...
const translations = {
  en: {
    ...
    intro:
      'This Privacy Policy explains how we collect, use, store, and protect your personal data when using our online store.',
    ...
    no_third_party_share:
      'We do not sell or rent your data, except in the following cases:',
    ...
    cookies_description:
      'We use cookies to improve the site and personalize your experience:',
    ...
    children_protection:
      'Our site is not intended for users under 18. We do not knowingly collect their data.',
    section_9: '9. Changes to This Policy',
    policy_changes:
      'We may update this policy periodically. We will notify you of major changes via email or on-site.',
  ...
  ru: {
    ...
    intro:
      'Настоящая Политика конфиденциальности описывает, как мы собираем, используем, храним и защищаем ваши персональные данные при использовании нашего интернет-магазина. Используя наш сайт, вы соглашаетесь с условиями данной политики.',
    ...
    return_instructions:
      'Если вы хотите вернуть или обменять товар, выполните следующие шаги:',
