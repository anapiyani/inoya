...
const translations = {
  ...
  "intro": "This Privacy Policy explains how we collect, use, store, and protect your personal data when using our online store.",
  "section_1": "1. What Information We Collect",
  ...
  "section_3": "3. Information Sharing with Third Parties",
  "no_third_party_share": "We do not sell or rent your data, except in the following cases:",
  ...
  "section_5": "5. Your Rights",
  "right_access": "Right to Access",
  "right_correction": "Right to Correction",
  "right_deletion": "Right to Deletion",
  "right_limit": "Right to Restrict Processing",
  "right_withdraw": "Right to Withdraw Consent",
  "section_6": "6. Cookies and Similar Technologies",
  "cookies_description": "We use cookies to improve the site and personalize your experience:",
  "cookies_required": "Required Cookies",
  "cookies_analytics": "Analytics Cookies",
  "cookies_marketing": "Marketing Cookies",
  "cookies_control": "You can control cookies in your browser settings.",
  "section_7": "7. Data Retention",
  "account_data": "Account Data",
  "order_history": "Order History",
  "marketing_data": "Marketing Data",
  "section_8": "8. Protection of Minors",
  "children_protection": "Our site is not intended for users under 18. We do not knowingly collect their data.",
  "section_9": "9. Changes to This Policy",
  "policy_changes": "We may update this policy periodically. We will notify you of major changes via email or on-site.",
  "section_10": "10. Contact Information",
  "contact_us": "If you have any questions, contact us:",
  "footer_note": "This policy complies with Federal Law 152-FZ and GDPR.",
  "section_11": "11. Return and Exchange",
  "return_instructions": "If you wish to return or exchange an item, follow these steps:",
  "return_step_1": "Log into your account.",
  "return_step_2": "Go to “My Orders”.",
  "return_step_3": "Find the order you want to return.",
  "return_step_4": "Click on the “Return” button.",
  "return_step_5": "Upload pictures of the item.",
  "return_step_6": "Submit the request — we will check eligibility.",
  "return_note": "If approved, we will send instructions to your email."
  },
  ru: {
    'nav.home': 'Главная',
    catalog: 'Каталог',
  ...
  "intro": "Настоящая Политика конфиденциальности описывает, как мы собираем, используем, храним и защищаем ваши персональные данные при использовании нашего интернет-магазина. Используя наш сайт, вы соглашаетесь с условиями данной политики.",
  "section_1": "1. Какую информацию мы собираем",
  "personal_info": "Персональная информация",
  "technical_info": "Техническая информация",
  "order_info": "Информация о заказах",
  "section_2": "2. Как мы используем вашу информацию",
  "order_processing": "Обработка заказов",
  "service_improvement": "Улучшение сервиса",
  "communication": "Коммуникация",
  "section_3": "3. Передача информации третьим лицам",
  "no_third_party_share": "Мы не продаём, не сдаём в аренду и не передаём ваши персональные данные третьим лицам, за исключением следующих случаев:",
  "service_providers": "Поставщики услуг",
  "legal_requirements": "Правовые требования",
  "user_consent": "Согласие пользователя",
  "section_4": "4. Безопасность данных",
  "technical_measures": "Технические меры",
  "organizational_measures": "Организационные меры",
  "section_5": "5. Ваши права",
  "right_access": "Право на доступ",
  "right_correction": "Право на исправление",
  "right_deletion": "Право на удаление",
  "right_limit": "Право на ограничение обработки",
  "right_withdraw": "Право на отзыв согласия",
  "section_6": "6. Файлы cookie и аналогичные технологии",
  "cookies_description": "Мы используем файлы cookie для улучшения работы сайта и персонализации вашего опыта:",
  "cookies_required": "Необходимые cookie",
  "cookies_analytics": "Аналитические cookie",
  "cookies_marketing": "Маркетинговые cookie",
  "cookies_control": "Вы можете управлять cookie в настройках браузера.",
  "section_7": "7. Сроки хранения данных",
  "account_data": "Данные аккаунта",
  "order_history": "История заказов",
  "marketing_data": "Маркетинговые данные",
  "section_8": "8. Защита данных несовершеннолетних",
  "children_protection": "Наш сайт не предназначен для лиц младше 18 лет...",
  "section_9": "9. Изменения в политике конфиденциальности",
  "policy_changes": "Мы можем периодически обновлять данную политику...",
  "section_10": "10. Контактная информация",
  "contact_us": "Если у вас есть вопросы, свяжитесь с нами:",
  "footer_note": "Данная политика составлена в соответствии с 152-ФЗ и GDPR.",
  "section_11": "11. Возврат и обмен товаров",
  "return_instructions": "Если вы хотите вернуть или обменять товар, выполните следующие шаги:",
  "return_step_1": "Войдите в свой аккаунт.",
  "return_step_2": "Перейдите в раздел «Мои заказы».",
  "return_step_3": "Найдите нужный заказ и откройте его.",
  "return_step_4": "Нажмите «Вернуть».",
  "return_step_5": "Загрузите фотографии товара.",
  "return_step_6": "Отправьте запрос — мы проверим возможность возврата.",
  "return_note": "После проверки мы свяжемся с вами по почте."
  },
};
