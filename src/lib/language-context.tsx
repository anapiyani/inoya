...
const translations = {
  en: {
    ...
    how_to_return_exchange_desc:
      'Follow these steps to request a return or exchange.',
    return_step_1:
      "Sign in to your account. If you're already signed in, continue.",
    return_step_2: 'Open "My Orders".',
    return_step_3: 'Find the order you want to return and open its details.',
    return_step_4: 'Click "Return" to open the return form (modal).',
    return_step_5: 'Upload photos showing the item and its condition.',
    return_step_6:
      "Submit your request — we'll review eligibility and get back to you.",
  },
  ru: {
    'nav.home': 'Главная',
    catalog: 'Каталог',
...
=======
    how_to_return_exchange_desc:
      'Выполните шаги ниже, чтобы отправить запрос на возврат или обмен.',
    return_step_1: 'Войдите в свой аккаунт. Если вы уже вошли — продолжайте.',
    return_step_2: 'Откройте раздел «Мои заказы».',
    return_step_3:
      'Найдите заказ, который хотите вернуть, и откройте его детали.',
    return_step_4: 'Нажмите «Вернуть», чтобы открыть форму (модальное окно).',
    return_step_5: 'Загрузите фотографии товара и его состояния.',
    return_step_6:
      'Отправьте запрос — мы проверим возможность возврата и свяжемся с вами.',
>>>>>>> Stashed changes
  },
};
